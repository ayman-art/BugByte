...
export const postQuestion = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.QUESTION}?communityId=${communityId}`,
      {
        method: "POST",
        headers: {
...
export const postAnswer = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.ANSWER}?questionId=${questionId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getQuestion = async (
  ...
  try {
    console.log(token);
    const response = await fetch(
      `${API_URLS.QUESTION}?questionId=${questionId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const getAnswer = async (
  ...
  try {
    const response = await fetch(`${API_URLS.ANSWER}/${answerId}`, {
      // Path variable
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getReply = async (
  ...
  try {
    const response = await fetch(`${API_URLS.REPLY}/${replyId}`, {
      // Path variable
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const verifyAnswer = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.ANSWER}/verify?answerId=${answerId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const upvoteQuestion = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.POST}/upvoteQuestion?postId=${questionId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const downvoteQuestion = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.POST}/downvoteQuestion?postId=${questionId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const removeUpvoteQuestion = async (
  questionId: number,
  token: string
): Promise<any> => {
  try {
    const response = await fetch(
      `${API_URLS.POST}/removeUpvoteQuestion?postId=${questionId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const removeDownvoteQuestion = async (
  questionId: number,
  token: string
): Promise<any> => {
  try {
    const response = await fetch(
      `${API_URLS.POST}/removeDownvoteQuestion?postId=${questionId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
    ...
    if (!response.ok) {
      const errorData = await response.json();
      throw new Error(
        errorData.message || "Failed to remove downvote question"
      );
    }
...
export const upvoteAnswer = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.POST}/upvoteAnswer?postId=${answerId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const downvoteAnswer = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.POST}/downvoteAnswer?postId=${answerId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const removeUpvoteAnswer = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.POST}/removeUpvoteAnswer?postId=${answerId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const removeDownvoteAnswer = async (
  answerId: string,
  token: string
): Promise<any> => {
  try {
    const response = await fetch(
      `${API_URLS.POST}/removeDownvoteAnswer?postId=${answerId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const getAnswersFromQuestion = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.ANSWER}?questionId=${questionId}&offset=${offset}&limit=${limit}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const getRepliesFromAnswer = async (
  ...
  try {
    const response = await fetch(
      `${API_URLS.REPLY}?answerId=${answerId}&offset=${offset}&limit=${limit}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
